% Fits regression (used in the article) model, computes and evaluates
% test-predictions, and creates the exercise-interaction plot.
...
% [lme, ~, stats] = fitlme(modelData(I_fit, :), formula);
Coeff_compact1 = compactLinModelPresentation(lme, {'Name', 'Estimate', 'pValue', 'sigLvl'}) %#ok<*NASGU>
...
if 1 == 0
    predictorNames = lme.PredictorNames
    save("model_jan_17.mat", "lme", "predictorNames")
end

get_plottable_parameter_table
Coeff_compact1(["hii", "hii^2"], "Estimate")

create_Latex_formatted_parameter_table
coefficient_names_Latex
sprintf("R-squared: %.3g", lme.Rsquared.Ordinary)

save(fullfile(navi.paths.models, "lme.mat"), "lme")
%% Maximal impact of PA and SRH
clear delta
delta.pa = Coeff_compact1{"PA_f4i3", 1} - Coeff_compact1{"PA_f1i1", 1};
x = 4
delta.hscl = Coeff_compact1{["hscl", "hscl^2", "hscl^3"], 1}'*([x, x^2, x^3] - 1)'
%% Combined effect of loosing weight, exercising, and improving mental health
clear delta

delta.extreme.pa =  Coeff_compact1{"PA_f4i3", 1} - Coeff_compact1{"PA_f1i1", 1};
delta.extreme.bmi = Coeff_compact1{"bmi_2", 1} - Coeff_compact1{"bmi_4", 1};
x = 3;
delta.extreme.hscl = Coeff_compact1{["hscl", "hscl^2", "hscl^3"], 1}'*(1 - [x, x^2, x^3])';

delta.extreme.pa + delta.extreme.bmi + delta.extreme.hscl 
...
CI_i1 = [; ...
    util_get_CI_for_paramDiff(lme, "PA_f1i1", "PA_f1i1", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f2i1", "PA_f1i1", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f3i1", "PA_f1i1", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f4i1", "PA_f1i1", "include_estimate", "middle"); ...
    ];
delta_PAfrq_i2 = [; ...
...
CI_i2 = [; ...
    util_get_CI_for_paramDiff(lme, "PA_f1i2", "PA_f1i1", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f2i2", "PA_f1i1", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f3i2", "PA_f1i1", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f4i2", "PA_f1i1", "include_estimate", "middle"); ...
    ];
delta_PAfrq_i3 = [; ...
...
CI_i3 = [; ...
    util_get_CI_for_paramDiff(lme, "PA_f1i3", "PA_f1i1", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f2i3", "PA_f1i1", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f3i3", "PA_f1i1", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f4i3", "PA_f1i1", "include_estimate", "middle"); ...
    ]
...
title(sprintf("(a) SRH for each PA subgroup relative \n to the least "+ ...
    "active group"), 'interpreter', 'latex')
...
delta_PAfrq_i2 = [; ...
    ...
    Coeff_compact1{"PA_f4i2", "Estimate"}];
CI_i2 = [; ...
    util_get_CI_for_paramDiff(lme, "PA_f1i2", "PA_f1i2", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f2i2", "PA_f1i2", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f3i2", "PA_f1i2", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f4i2", "PA_f1i2", "include_estimate", "middle"); ...
    ];
delta_PAfrq_i3 = [; ...
    Coeff_compact1{"PA_f1i3", "Estimate"}; ...
    Coeff_compact1{"PA_f2i3", "Estimate"}; ...
    ...
    Coeff_compact1{"PA_f4i3", "Estimate"}];
CI_i3 = [; ...
    util_get_CI_for_paramDiff(lme, "PA_f1i3", "PA_f1i3", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f2i3", "PA_f1i3", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f3i3", "PA_f1i3", "include_estimate", "middle"); ...
    util_get_CI_for_paramDiff(lme, "PA_f4i3", "PA_f1i3", "include_estimate", "middle"); ...
    ]
delta_PAfrq_i1 = delta_PAfrq_i1 - Coeff_compact1{"PA_f1i1", "Estimate"};
...
xlabel("N.o. exercise sessions per week", "Interpreter", "latex")
ylabel("SRH", "Interpreter", "latex")
title(sprintf("(b) Effect on SRH of increasing frequency\n"+ ...
    "within each PA-intensity subgroup"), "interpreter", "latex")
...
r = y_hat - y;
R.metrics.noInsomnia.train = util_get_predictionMetrics(y, y_hat);
close all
...
metrics.RMSE = rmse(y, y_hat);
metrics.correlation = corr([y, y_hat]);
metrics.correlation = metrics.correlation(1, 2);
y_hat_discr = round(y_hat);
metrics.acc_goodBad = mean((y_hat_discr > 2) == (y > 2));
...
plotCIforEachCat(y, y_hat)
ylim([1, 4])
ylabel('predicted SRH', "interpreter", "latex")
xlabel('SRH', "interpreter", "latex")
title("Predicted vs actual SRH", "interpreter", "latex")
...
R.metrics.noInsomnia.test = util_get_predictionMetrics(y, y_hat);
R.metrics.noInsomnia.test
